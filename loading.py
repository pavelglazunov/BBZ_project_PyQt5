...
class Loading(QWidget):
    ...
    def initUI(self):
        ...
        self.loading_btn.setWindowOpacity(0.5)
        ...
        # self.two_player_game = QPushButton(self)
        # self.two_player_game.resize(200, 50)
        # self.two_player_game.move(550, 400)
        # self.two_player_game.setIcon(QIcon('./texture/loading_texture/two_player_btn.png'))
        # self.two_player_game.setIconSize(QSize(200, 50))
        # self.two_player_game.clicked.connect(self.two_player)
        # self.two_player_game.hide()
    ...
    def loading(self):
        if self.loading_btn_size_x < 495:
            ...
            # for i in range(100):
            #     self.loading_btn.setGraphicsEffect(QGraphicsOpacityEffect(opacity=.5))
    ...
    # self.leter_B1_pos_x = 660
    # self.leter_B1_pos_y = -10
    # self.bonus_mouse.move(self.leter_B1_pos_x, self.leter_B1_pos_y)
